...
import customnet.lingala.zip4j.io.outputstream.SplitOutputStream;
import customnet.lingala.zip4j.io.outputstream.ZipOutputStream;
...
import customnet.lingala.zip4j.model.enums.CompressionMethod;
import customnet.lingala.zip4j.model.enums.EncryptionMethod;
...
import customnet.lingala.zip4j.util.BitUtils;
...
import static customnet.lingala.zip4j.headers.HeaderUtil.getFileHeader;
import static customnet.lingala.zip4j.model.ZipParameters.SymbolicLinkAction.INCLUDE_LINK_AND_LINKED_FILE;
import static customnet.lingala.zip4j.model.ZipParameters.SymbolicLinkAction.INCLUDE_LINK_ONLY;
import static customnet.lingala.zip4j.model.enums.CompressionMethod.DEFLATE;
import static customnet.lingala.zip4j.model.enums.CompressionMethod.STORE;
import static customnet.lingala.zip4j.model.enums.EncryptionMethod.NONE;
import static customnet.lingala.zip4j.model.enums.EncryptionMethod.ZIP_STANDARD;
import static customnet.lingala.zip4j.progress.ProgressMonitor.Task.ADD_ENTRY;
import static customnet.lingala.zip4j.progress.ProgressMonitor.Task.CALCULATE_CRC;
import static customnet.lingala.zip4j.progress.ProgressMonitor.Task.REMOVE_ENTRY;
import static customnet.lingala.zip4j.util.CrcUtil.computeFileCrc;
import static customnet.lingala.zip4j.util.FileUtils.assertFilesExist;
import static customnet.lingala.zip4j.util.FileUtils.getRelativeFileName;
import static customnet.lingala.zip4j.util.Zip4jUtil.epochToExtendedDosTime;
