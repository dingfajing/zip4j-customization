...
import static customnet.lingala.zip4j.util.Zip4jUtil.getCompressionMethod;

import customnet.lingala.zip4j.exception.ZipException;
import customnet.lingala.zip4j.headers.HeaderReader;
import customnet.lingala.zip4j.headers.HeaderSignature;
...
import customnet.lingala.zip4j.util.PasswordCallback;
