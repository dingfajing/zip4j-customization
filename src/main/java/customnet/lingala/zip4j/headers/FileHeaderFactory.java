...
import customnet.lingala.zip4j.model.enums.CompressionLevel;
...
import static customnet.lingala.zip4j.util.BitUtils.setBit;
import static customnet.lingala.zip4j.util.BitUtils.unsetBit;
import static customnet.lingala.zip4j.util.FileUtils.isZipEntryDirectory;
import static customnet.lingala.zip4j.util.ZipVersionUtils.determineVersionMadeBy;
import static customnet.lingala.zip4j.util.ZipVersionUtils.determineVersionNeededToExtract;
